...
public class KafKaConfig {
    ...
    public KafKaRegisterSuccConsumerFactory kafKaRegisterSuccConsumerFactory() {
        ...
        consumerProperties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonSerializer.class);
        consumerProperties.put(ConsumerConfig.GROUP_ID_CONFIG, "default");
        consumerProperties.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false);//消费者自动提交方式关闭
